      ...
      >
        ...
        >
          ...
          <div className="flex flex-col md:gap-0 gap-2  text-nowrap  md:flex-row justify-center items-center  w-[25vw] md:w-full">
            ...
            <div className="order-4 md:px-4 md:mx-2 px-2 text-nowrap  ">
              <Link className="underline-animation" to="/workoutlog">
                Workout Log
              </Link>
            </div>
            <div className="order-5md:px-4 md:mx-2 px-2 text-nowrap  ">
            ...
            {nuser ? (
              ...
              <div className=" mx-auto order-6 rounded-xl border-[#464646] border-2 md:px-2 md:py-1 hover:bg-gray-600 flex justify-center items-center md:w-full w-[60%]  ">
                <button>
